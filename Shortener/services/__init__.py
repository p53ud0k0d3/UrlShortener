...
class CustomShortener(object):
    ...
    def __init__(self, **kwargs):
        ...
        module = importlib.import_module('Shortener.services.shorteners')
    ...
    def __getattr__(self, attr):
        ...
        short_module = importlib.import_module(
            '{}.{}'.format('Shortener.services.shorteners', attr)
        )
        instance = getattr(short_module, 'CustomShortener')(**self.kwargs)
